...
<html>
    ...
    <body>
        ...
        <div class="login">
            <form class="form-horizontal"method="post" action="11_registerCopy.jsp">
                Copy ID:<input class="form-control" type="text" name="copyid" ><br>
                Book ID:<input class="form-control" type="text" name="bookid" value=<%=bookId%> ><br>
                구매일자:<input class="form-control" type="text" name="purchasedate" ><br>
                대출 여부: <select name="rentstate">
                    <option value=false>대출가능</option>
                    <option value=true>대출불가능</option>
                </select>
